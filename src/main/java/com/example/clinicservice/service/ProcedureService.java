...
//    List<Procedure> findAllByDoctorOrderByProcedureDateAscStartTimeAsc(String doctorName);
//    List<Procedure> findAllByDoctorAndProcedureNameOrderByProcedureDateAscStartTimeAsc(String doctorName, String procedureName);
}
